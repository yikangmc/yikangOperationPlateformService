...
public class InterfaceUtil {
	...
	static{
		...
		//重置密码
		YiKangServiceConfige getUserList=new YiKangServiceConfige();
		getUserList.setServiceName("userService");
		getUserList.setMethodName("getUserList");
		getUserList.setIsFileter(false);
		mathodServiceConfig.put("00-17-09",getUserList);
...
//		预约用户
		YiKangServiceConfige appointmentOrderGetList=new YiKangServiceConfige();
		appointmentOrderGetList.setServiceName("appointmentOrderService");
		appointmentOrderGetList.setMethodName("getAppointmentOrderList");
		appointmentOrderGetList.setIsFileter(false);
		mathodServiceConfig.put("00-21-07",appointmentOrderGetList);
...
//		预约用户
		YiKangServiceConfige appointmentUserGetList=new YiKangServiceConfige();
		appointmentUserGetList.setServiceName("appointmentUserService");
		appointmentUserGetList.setMethodName("getAppointmentList");
		appointmentUserGetList.setIsFileter(false);
		mathodServiceConfig.put("00-23-01",appointmentUserGetList);
